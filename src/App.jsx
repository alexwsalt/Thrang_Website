          ...
          <div style={{opacity:mounted?1:0,transition:"opacity 0.5s"}}>
            ...
            <section className="hero-section" style={{position:"relative",minHeight:560,display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden"}}>
              ...
              <div style={{position:"relative",textAlign:"center",color:"#fff",padding:"60px 24px",maxWidth:620}}>
                <p style={{fontSize:10,letterSpacing:"0.3em",textTransform:"uppercase",color:"#fff",opacity:0.97,marginBottom:22,fontFamily:FB,fontWeight:600,textShadow:"0 2px 6px rgba(0,0,0,0.5)"}}>Chapel Stile · Langdale Valley</p>
                <h1 className="hero-title" style={{fontSize:62,fontWeight:600,margin:"0 0 18px",letterSpacing:"0.12em",lineHeight:1.05,fontFamily:FH,textShadow:"0 3px 8px rgba(0,0,0,0.5)"}}>Thrang Properties</h1>
                <p className="hero-sub" style={{fontSize:17,opacity:0.78,marginBottom:48,lineHeight:1.7,fontFamily:FB,fontWeight:500,textShadow:"0 2px 6px rgba(0,0,0,0.5)"}}>Two exceptional properties in the heart of the Lakeland fells</p>
                <button onClick={()=>navigate("login")} style={{background:"transparent",color:"#fff",border:"1px solid rgba(255,255,255,0.5)",padding:"13px 40px",fontSize:13,fontFamily:FB,fontWeight:600,letterSpacing:"0.1em",textTransform:"uppercase",transition:"background 0.2s",textShadow:"0 2px 6px rgba(0,0,0,0.5)"}}>
                  Request a Stay
                </button>
              </div>
            </section>
              ...
              <div style={{maxWidth:1000,margin:"0 auto"}}>
                ...
                <div className="showcase-img" style={{position:"relative",overflow:"hidden",height:480,border:`1px solid ${C.stone}`}}>
                  ...
                  <div className="showcase-text" style={{position:"absolute",bottom:36,left:40,right:40,color:"#fff"}}>
                    <p style={{fontSize:10,letterSpacing:"0.26em",textTransform:"uppercase",color:"#fff",opacity:0.97,marginBottom:10,fontFamily:FB,fontWeight:600,textShadow:"0 2px 6px rgba(0,0,0,0.5)"}}>Chapel Stile · Langdale Valley</p>
